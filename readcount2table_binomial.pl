...
if ($anzahl == 1) {@zeile=split("\t", $index[0]);
	...
	print Fout "$zeile[0]\t$zeile[1]\t$zeile[2]\t$array[3]\t$As[1]\t$As[3]\t$freqA\t$Cs[1]\t$Cs[3]\t$freqC\t$Gs[1]\t$Gs[3]\t$freqG\t$Ts[1]\t$Ts[3]\t$freqT\t$freqALT\t$qualALT\t$Q\t$zeile[3]\n";
		    $h{$array[1]}=1;
}
  elsif ($anzahl == 2) {
		@zeile=split("\t", $index[0]);
	...
	print Fout "$zeile[0]\t$zeile[1]\t$zeile[2]\t$array[3]\t$As[1]\t$As[3]\t$freqA\t$Cs[1]\t$Cs[3]\t$freqC\t$Gs[1]\t$Gs[3]\t$freqG\t$Ts[1]\t$Ts[3]\t$freqT\t$freqALT\t$qualALT\t$Q\t$zeile[3]\n";
	print Fout "$zeile2[0]\t$zeile2[1]\t$zeile2[2]\t$array[3]\t$As[1]\t$As[3]\t$freqA\t$Cs[1]\t$Cs[3]\t$freqC\t$Gs[1]\t$Gs[3]\t$freqG\t$Ts[1]\t$Ts[3]\t$freqT\t$freqALT2\t$qualALT2\t$Q2\t$zeile2[3]\n";
	$h{$array[1]}=1;
   }
  elsif ($anzahl == 3) {
		@zeile=split("\t", $index[0]);
	...
	print Fout "$zeile[0]\t$zeile[1]\t$zeile[2]\t$array[3]\t$As[1]\t$As[3]\t$freqA\t$Cs[1]\t$Cs[3]\t$freqC\t$Gs[1]\t$Gs[3]\t$freqG\t$Ts[1]\t$Ts[3]\t$freqT\t$freqALT\t$qualALT\t$Q\t$zeile[3]\n";
	print Fout "$zeile2[0]\t$zeile2[1]\t$zeile2[2]\t$array[3]\t$As[1]\t$As[3]\t$freqA\t$Cs[1]\t$Cs[3]\t$freqC\t$Gs[1]\t$Gs[3]\t$freqG\t$Ts[1]\t$Ts[3]\t$freqT\t$freqALT2\t$qualALT2\t$Q2\t$zeile2[3]\n";
	print Fout "$zeile3[0]\t$zeile3[1]\t$zeile3[2]\t$array[3]\t$As[1]\t$As[3]\t$freqA\t$Cs[1]\t$Cs[3]\t$freqC\t$Gs[1]\t$Gs[3]\t$freqG\t$Ts[1]\t$Ts[3]\t$freqT\t$freqALT3\t$qualALT3\t$Q3\t$zeile3[3]\n";
	$h{$array[1]}=1;
  }
